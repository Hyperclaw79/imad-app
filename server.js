...
function updateComment(comment){
    ...
    `<html>
       ...
       <body>
          <script>
              setInterval(function(){$('#comcont').text(${subTemplate});},1000)
          </script>
          ...
          <div id = "commcont" style="margin: 30px;background-color: rgba(255, 255, 255, 0.4);border: 5px solid black;box-shadow:10px 10px 5px rgba(0,0,0,.2);border-radius:10px;">
